...
public void forceLayout(){} public void layout(int l,int t,int r,int b){this.l=l;this.t=t;this.r=r;this.b=b;}
...
'app/nebulagram/ui/NebulaAppearance.java': 'package app.nebulagram.ui; public class NebulaAppearance {public static boolean enabled=true; public static boolean iosComposer(){return enabled;} public static boolean chatHeader(){return enabled;}}',
'org/telegram/ui/ActionBar/ActionBar.java': 'package org.telegram.ui.ActionBar; public class ActionBar {public void setNebulaFloatingChatHeader(boolean a,boolean b,boolean c){}}',
...
sources += [str(overlay / name) for name in ['NebulaComposerStyle.java','NebulaAttachmentButton.java','NebulaChatStyle.java']]
out = work / 'classes'
