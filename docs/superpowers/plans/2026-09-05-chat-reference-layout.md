...
6. [x] Compile the affected Android code and verify geometry for short/long headers and empty/typed/forwarding input. Record any device testing limit accurately.
...
Follow-up: device screenshots exposed two gaps in these original checks: shared mutable RenderNode state and SimpleTextView centering cached during measurement. See `2026-09-05-chat-rendering-fixes.md` for the repairs and additional regression coverage.
