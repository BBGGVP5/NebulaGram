...
public final class NebulaMenuStrings {
    ...
    static {
        ...
        TEXTS.put("nl_advanced", new String[]{"Дополнительно", "Advanced"});
        TEXTS.put("nl_advanced_sub", new String[]{"Способ замера, идентификатор и ядра", "Latency method, device id and cores"});
        ...
        TEXTS.put("nl_guard_sub", new String[]{"Ваш лучший сервис для свободного интернета", "Your go-to service for internet freedom"});
        ...
        TEXTS.put("nl_open_provider", new String[]{"Страница провайдера", "Open provider page"});
        TEXTS.put("nl_open_provider_sub", new String[]{"Пополнить, продлить, прочитать объявления", "Top up, renew or read announcements"});
        ...
        TEXTS.put("nl_source", new String[]{"Источник серверов", "Server source"});
        TEXTS.put("nl_source_sub", new String[]{"Подписки, ключи и фильтры", "Subscriptions, manual keys and filters"});
